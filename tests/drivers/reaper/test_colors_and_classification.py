"""Tests for REAPER colour decoding and the dialect classification helpers.

Classification cases are grounded in real-session track names (ported from
the prototype's ``test_utils.py``); colour tests exercise the REAPER-specific
packed-int byte-order logic directly.
"""

from __future__ import annotations

from session_explorer.drivers.reaper.colors import decode_color, swell_platform
from session_explorer.drivers.reaper.keywords import (
    classify_fx_family,
    classify_track_role,
)
...
# ---------------------------------------------------------------------------
# FX-family classification (knowledge table first, keywords second)
# ---------------------------------------------------------------------------
