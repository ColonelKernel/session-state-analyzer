...
extraction is a separate, heavier step (``core.audio.descriptors``).

Ported verbatim from the Logic prototype; role inference now comes from
:mod:`session_explorer.core.roles` (where the benchmarked engine was
promoted).
"""
...
from ...core import roles as role_inference
from . import utils
from .native_models import AudioEvidence
